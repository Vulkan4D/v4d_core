...
#define START_UNIT_TESTS using namespace v4d::tests; int main() { LOGGER_INSTANCE->SetVerbose(false); LOG("Started unit tests"); int result = 0; { V4D_PROJECT_INSTANTIATE_CORE_IN_MAIN( v4dCore ) 
