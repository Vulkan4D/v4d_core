...
namespace v4d::modules {
	...
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_MISC			= 0x00000000LL << 32;
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_CORE			= 0x00000001LL << 32;
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_PROCESSING	= 0x00000002LL << 32;
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_NETWORKING	= 0x00000004LL << 32;
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_GRAPHICS		= 0x00000008LL << 32;
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_AUDIO			= 0x00000010LL << 32;
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_DATA			= 0x00000020LL << 32;
	const SUBMODULE_TYPE_T SUBMODULE_TYPE_TEST			= 0x00000040LL << 32;
...
#include "submodules/V4DRendering.hpp"
